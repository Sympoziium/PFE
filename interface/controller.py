...
Centralise la logique des endpoints; `flask_server.py` ne fait que lier les routes
à ces méthodes.
"""
...
from interface.TemplateOnglet import render_template_tab  # Exemple d'onglet template générique
